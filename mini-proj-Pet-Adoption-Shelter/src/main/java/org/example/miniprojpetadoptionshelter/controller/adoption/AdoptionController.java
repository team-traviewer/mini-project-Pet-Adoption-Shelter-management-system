...
public class AdoptionController {
    ...
    @PostMapping
    public ResponseEntity<ResponseDto<AdoptionResponse>> createAdoption(
    ...
    public ResponseEntity<ResponseDto<AdoptionResponse>> getAdoptionById(
    ...
    public ResponseEntity<ResponseDto<AdoptionResponse>> updateAdoption(
            @PathVariable Long adoptionId,
