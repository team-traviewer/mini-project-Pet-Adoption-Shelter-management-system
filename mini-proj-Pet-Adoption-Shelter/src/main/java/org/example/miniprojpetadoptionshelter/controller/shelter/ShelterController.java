...
import org.example.miniprojpetadoptionshelter.dto.shelter.request.ShelterCreateReq;
...
public class ShelterController {
    ...
    public ResponseEntity<ResponseDto<Void>> createShelter(
            @AuthenticationPrincipal UserPrincipal userPrincipal,
            @RequestBody ShelterCreateReq request
            ) {
        ResponseDto<Void> response = shelterService.createShelter(request);
